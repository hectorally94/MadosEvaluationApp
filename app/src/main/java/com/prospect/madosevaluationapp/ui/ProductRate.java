...
public class ProductRate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //textViewtoo.setText("ProductRate");
...
// Inflate the header view at runtime
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            case R.id.dashbord:
                Intent intentdash = new Intent(getApplicationContext(), Dashbord.class);
            ...
            default:
                ...
                // Toast.makeText(ProductRate.this,"No Activity selected",Toast.LENGTH_LONG).show();
