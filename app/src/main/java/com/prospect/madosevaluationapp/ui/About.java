    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            case R.id.dashbord:
                ...
                Intent intentd = new Intent(getApplicationContext(), Dashbord.class);
                // start the Intent
            ...
            default:
                ...
                // Toast.makeText(About.this,"No Activity selected",Toast.LENGTH_LONG).show();
