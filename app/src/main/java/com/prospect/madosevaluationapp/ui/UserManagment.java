...
public class UserManagment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //textViewtoo.setText("UserManagment");
...
// Inflate the header view at runtime
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            case R.id.dashbord:
                Intent intentu = new Intent(getApplicationContext(), Dashbord.class);
            ...
            case R.id.idabout:
                ...
                break;
            default:
                // Toast.makeText(UserManagment.this,"No Activity selected",Toast.LENGTH_LONG).show();
        }
